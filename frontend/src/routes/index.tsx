...
// Updated reliable high-res model images and dark minimal overlays
const HERO_SLIDES = [
  {
    title: "Everyday Gold,",
...
function Home() {
  ...
  return (
    <Layout>
      {/* Full-width Model Banner Carousel with Dark Minimal Overlay */}
      <section className="relative h-[80vh] min-h-[520px] max-h-[720px] overflow-hidden bg-black">
        {HERO_SLIDES.map((slide, idx) => (
          ...
          >
            {/* Background Model Image - full size, not obscured */}
            <img
              src={slide.image}
              alt={slide.title}
